...
//테이블의 컬럼 구성과 같은 클래스를 정의하여 값을 저장하기 위한 것이다.
//VO : Value Object 는 불변객체로 equals와 hashcode 재정의를 하여 set 또는 map 객체에서 활용,
//DTO : Data Transfer Object는 가변객체로 데이터를 객체간에 전달하기 위한 목적이다.
